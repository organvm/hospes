...
*The thing you build to solve your own problem always turns out to be about something else.*

Every maker who works at the intersection of hand and system discovers, at some point, that the
artifact they thought they were making was a proxy for a different question. The conversation
surfaces what that question was — and whether answering it changed the work.
...
- **Artifact production in-session:** Can the show actually produce a working artifact in the room?
  ...
  conversation. That object becomes part of the episode record. The stress test is whether the
  ask lands naturally or feels forced.
...
New York City. The guest's own working space is preferred over a neutral studio — an artist's
studio, a writer's office, a workshop. If the guest's space is not available, a spare conversation
room in a co-working building the guest already uses. No visible microphones. Two redundant hidden
audio channels. The guest should feel like they're talking in their own territory, not being
interviewed.
...
**Segment timing.** The three-part structure — Claim, Stress Test, Artifact — needs to hold for a
full episode with a non-performer guest. This is the hardest timing test because a comedian or
media-native guest will smooth over structural gaps; this guest will not. By the end of this
recording the team will know whether the fixed structure is durable, or whether it needs a
different clock in the room to enforce it.
