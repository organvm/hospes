# Outreach Templates v0

All external messages must have a real human owner. AI may research, draft, classify, and schedule; it does not impersonate a nonexistent employee.
...
We can record professionally in Los Angeles, New York City, or Austin and route the session around [GUEST]’s existing schedule. The recording would take approximately [DURATION], and there is no expectation that the guest promote the episode.

Would [GUEST] be open to considering [DATE WINDOW]? I can send the one-page editorial brief.
...
May I send the one-page brief and proposed windows?
...
One routine follow-up after silence. No automated second, third, or fourth nudge. Protected relationships require explicit approval for every message.
